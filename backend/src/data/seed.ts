...
export const SEED_ORDERS: ProductionOrder[] = [
  ...
  },
  {
    ...
    status: "in_progress",
    pendingApproval: false,
    note: "Theo ĐMKT documents/2-VAN CỬA NOVO 20.xlsx",
    attachments: [],
    boms: [
      {
        id: "b-vc1",
        bomCode: "BOM-LSX2024005-001",
        partCode: "VC20-THAN",
        partName: "Thân van cửa NOVO 20",
        rawMaterial: "Đồng Ø25",
        machine: "Dập nóng",
        process: "Cắt phôi → Dập → Đánh bóng → Gia công",
        targetQty: 500,
        passQty: 320,
        failQty: 8,
        assignedTeamId: "t_hot",
        ...
        processStage: "hot_forge",
        status: "in_progress",
        semiProductId: "sp-vc-body",
        specCols: ["Ø25", "Dài", "NQ", "", "", "", "", "", "", "", ""],
        techNote: "Theo bản vẽ thân van cửa.",
        workerEntries: [],
      },
      {
        id: "b-vc2",
        bomCode: "BOM-LSX2024005-002",
        partCode: "VC20-NAP",
        partName: "Nắp van cửa NOVO 20",
        rawMaterial: "Đồng Ø22",
        machine: "Dập nóng",
        process: "Cắt phôi → Dập → Hoàn thiện",
        targetQty: 500,
        passQty: 280,
        failQty: 5,
        assignedTeamId: "t_hot",
      ...
      {
        id: "b-vc3",
        bomCode: "BOM-LSX2024005-003",
        partCode: "VC20-DIA",
        partName: "Đĩa van cửa NOVO 20",
        rawMaterial: "Đồng Ø15",
        machine: "Dập + CNC",
        process: "Cắt → Dập → Khoan taro → Cắt côn",
        targetQty: 500,
        passQty: 210,
        failQty: 12,
        assignedTeamId: "t_hot",
      ...
      {
        id: "b-vc4",
        bomCode: "BOM-LSX2024005-004",
        partCode: "VC20-TRUC",
        partName: "Trục van cửa NOVO 20",
        rawMaterial: "Đồng Ø9",
        machine: "Tiện ren / Phay",
        process: "Cắt phôi → Ren thang → Ren met → Phay giác",
        targetQty: 500,
        passQty: 410,
        failQty: 3,
        assignedTeamId: "t_auto",
        ...
        processStage: "auto",
        status: "in_progress",
        semiProductId: "sp-vc-shaft",
        specCols: checklistToSpecCols([
          { name: "Chiều dài", target: 74.5, unit: "mm", min: 74.3, max: 74.7 },
          { name: "Ren thang", type: "qualitative", hint: "Theo bản vẽ" },
          { name: "Ren met", type: "qualitative" },
          { name: "Phay giác", type: "qualitative" },
        ]),
        materialSpecs: buildMaterialSpecsFromChecklist([
          { name: "Chiều dài", target: 74.5, unit: "mm", min: 74.3, max: 74.7 },
          { name: "Ren thang", type: "qualitative", hint: "Theo bản vẽ" },
          { name: "Ren met", type: "qualitative" },
          { name: "Phay giác", type: "qualitative" },
        ]),
        techNote: "Theo ĐMKT Trục van cửa novo 20.",
        workerEntries: [],
      },
      {
        id: "b-vc5",
        bomCode: "BOM-LSX2024005-005",
        partCode: "VC20-OCAL",
        partName: "Ốc áp lực van cửa NOVO 20",
        rawMaterial: "Đồng SW18",
        machine: "CAM",
        process: "Gia công hoàn chỉnh",
        targetQty: 500,
        passQty: 450,
        failQty: 2,
        assignedTeamId: "t_auto",
      ...
      {
        id: "b-vc6",
        bomCode: "BOM-LSX2024005-006",
        partCode: "VC20-OCDT8",
        partName: "Ốc đệm T8",
        rawMaterial: "Đồng Ø14",
        machine: "CAM",
        process: "Ren lắp ráp → Phay rãnh",
        targetQty: 500,
        passQty: 390,
        failQty: 4,
        assignedTeamId: "t_auto",
